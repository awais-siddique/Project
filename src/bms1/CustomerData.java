...
public class CustomerData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Customer's Data Form");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Father, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, 470, 530));
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -30, -1, 910));
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ...
        if(CNICValidator.isValidCNICFormat(cnic))
        {
            if(PhoneNumberValidator.isValidPhoneNumberFormat(phone))
            {
                if(EmailValidator.isValidEmail(email))
                {
                    try
                    {
                        ...
                        ptst.setString(3, cnic);    
                        ptst.setString(4, father);  
                ...
                {
                    JOptionPane.showMessageDialog(this, "Please Enter Email : abc@gmail.com");
                }
            }
            else
            {
                JOptionPane.showMessageDialog(this, "Please Enter Phone No. : 03XX-XXXXXXX");
            }
        }
        else
        {
            JOptionPane.showMessageDialog(this, "Please Enter CNIC : 12345-1234567-1");
        }
